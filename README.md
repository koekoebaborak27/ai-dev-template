...
1. **新しいプロジェクト用のリポジトリを作り、テンプレートの中身を持ってくる。** GitHub の「テンプレートリポジトリ」機能を使う通常の手順と、それを使わない完全手動の手順を [`docs/development/本テンプレートPJをコピーする方法.md`](docs/development/本テンプレートPJをコピーする方法.md) にまとめてある。
2. 次の 5 か所を書き換える。
